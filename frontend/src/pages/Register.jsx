        ...
        <div className="min-h-[calc(100vh-80px)] flex items-center justify-center px-4 relative overflow-hidden">
            ...
            <div className="max-w-md w-full glass p-10 rounded-3xl shadow-2xl relative z-10">
                <div className="text-center mb-10">
                    <h1 className="text-4xl font-black font-display tracking-tight text-white mb-3">Join the Elite</h1>
                    <p className="text-gray-400 font-medium">Start your high-performance task journey</p>
                </div>
                {error && (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <label className="block text-xs font-black uppercase tracking-widest text-gray-500 mb-2 ml-1">Full Identity</label>
                        <input
                            type="text"
                ...
                <p className="text-center mt-10 text-gray-400 font-medium text-sm">
                    ...
                    <Link to="/login" className="text-primary font-black hover:text-white transition-colors">
                        Sign In
                    </Link>
                </p>
            </div>
